<nav x-data="{ open: false }" class="tw-bg-white tw-dark:tw-bg-gray-800 tw-border-b tw-border-gray-100 tw-dark:tw-border-gray-700">
    ...
    <div class="tw-max-w-7xl tw-mx-auto tw-px-4 sm:tw-px-6 lg:tw-px-8">
        <div class="tw-flex tw-justify-between tw-h-16">
            ...
            <!-- Hamburger -->
            <div class="tw-hidden tw-me-2 tw-flex tw-items-center tw-sm:hidden">
                <button @click="open = ! open" class="tw-inline-flex tw-items-center tw-justify-center tw-p-2 tw-rounded-md tw-text-gray-400 tw-dark:text-gray-500 tw-hover:tw-text-gray-500 tw-dark:hover:tw-text-gray-400 hover:tw-bg-gray-100 tw-dark:hover:tw-
                bg-gray-900 tw-focus:tw-outline-none tw-focus:bg-gray-100 tw-dark:focus:bg-gray-900 tw-focus:text-gray-500 tw-dark:focus:text-gray-400 tw-transition tw-duration-150 tw-ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="tw-hidden tw-sm:hidden">
